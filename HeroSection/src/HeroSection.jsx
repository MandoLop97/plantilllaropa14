...
import { useDynamicBusinessConfig } from './hooks/useDynamicBusinessConfig.js';
import { useHeroAspectRatio } from './hooks/useHeroAspectRatio.js';
import { useThemeConfigData } from './hooks/useThemeConfigData.js';
...
function HeroSection() {
  ...
  const { isLoading: themeLoading } = useThemeConfigData();
  ...
  return (
    <section ref={heroRef} className="relative mb-8">
      ...
      <div className="w-full max-w-7xl mx-auto overflow-hidden relative rounded-b-3xl shadow-xl">
        <AspectRatio ratio={ratio} className="bg-gradient-to-br from-primary-100 to-primary-200 rounded-b-3xl">
          <div
            className="relative w-full h-full overflow-hidden rounded-b-3xl"
          ...
          >
            <motion.div
              ...
              animate={{ opacity: isBannerLoaded ? 1 : 0, scale: isHovered ? 1.04 : 1 }}
      ...
      <div className="relative">
        <div className="max-w-4xl mx-auto flex justify-center -mt-16 z-30 relative">
          ...
          >
            <Avatar
              className="h-28 w-28 border-2 border-white bg-white"
              style={{
                boxShadow: `
      ...
      <div className="text-center mt-2 mb-4">
        ...
        <div className="max-w-2xl mx-auto px-6">
          <div
            className="backdrop-blur-md rounded-2xl p-4 shadow-md"
            style={{
          ...
          >
            <p
              ...
              style={{ color: `hsl(var(--color-primary-700, 51 65 85))` }}
            >
