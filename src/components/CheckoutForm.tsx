        ...
        <div className="flex-1 p-4 space-y-6">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            <div className="flex items-center gap-2 mb-3">
              <Tag size={18} className="text-picton-blue-500" />
              ...
              <div className="space-y-3">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-picton-blue-500 text-sm"
                    onKeyPress={(e) => e.key === 'Enter' && handleApplyCoupon()}
                  />
                  <button
                    onClick={handleApplyCoupon}
                    className="px-4 py-2 bg-picton-blue-500 text-white rounded-lg hover:bg-picton-blue-600 transition-colors text-sm font-medium"
                  >
                    Aplicar
                  </button>
                </div>
