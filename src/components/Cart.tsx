            ...
            {items.length === 0 ? (
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-neutral-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                  <span className="text-neutral-400 text-2xl">🛍️</span>
                </div>
              ...
              <div className="space-y-4">
                {items.map(item => (
                  <div key={item.id} className="flex items-center space-x-3 bg-neutral-50 rounded-xl p-3">
                    <img
                      src={item.image}
                      alt={item.name}
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="w-7 h-7 rounded-full bg-white border flex items-center justify-center hover:border-primary-500 transition-colors"
                      >
                        <Minus size={12} />
                      </button>
            ...
            <div className="border-t p-4 space-y-4">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full bg-primary-500 text-white font-semibold py-3 rounded-xl hover:bg-primary-600 transition-all duration-200 flex items-center justify-center space-x-2"
                >
                  <ShoppingBag size={18} />
