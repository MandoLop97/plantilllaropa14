    ...
    >
      <div className="flex gap-4">
        ...
        <div className="relative w-24 h-24 bg-gray-50 rounded-lg overflow-hidden flex-shrink-0">
          {product.discount && (
            <div className="absolute top-1 left-1 bg-picton-blue-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full z-10">
              -{product.discount}%
            </div>
          )}
          <img
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
            <h3 className="font-semibold text-gray-900 group-hover:text-picton-blue-600 transition-colors line-clamp-1">
              {product.name}
            </h3>
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="flex items-center space-x-2">
              ...
              {product.discount && (
                <span className="text-xs bg-picton-blue-100 text-picton-blue-600 font-bold px-2 py-0.5 rounded-full">
                  -{product.discount}%
                </span>
              )}
            </div>
