    ...
    <section className="relative mb-15 py-0">
      ...
      <div className="relative">
        <div className="max-w-4xl mx-auto flex justify-center -mt-20 z-30 relative">
          <div
            ...
            style={{
              boxShadow: `
                0 12px 24px -8px color-mix(in srgb, hsl(var(--color-primary-500)) 20%, transparent),
                0 0 0 2px color-mix(in srgb, hsl(var(--color-primary-100)) 40%, transparent)
              `
            }}
          >
            <Avatar
              className="h-32 w-32 border-2 border-white bg-white"
              style={{
                boxShadow: `
                  0 6px 10px -2px color-mix(in srgb, hsl(var(--color-primary-300)) 20%, transparent)
                `
              }}
            >
              <AvatarImage
      ...
      <div className="text-center mt-2 mb-8">
        <h1 
          ...
          className="text-4xl md:text-5xl font-extrabold text-primary-800 mb-3 tracking-tight drop-shadow-sm py-[6px]"
        >
          {businessConfig.name}
        </h1>
        ...
        <div className="max-w-2xl mx-auto px-6">
          <div 
            className="backdrop-blur-md rounded-2xl p-8 shadow-md"
            style={{
