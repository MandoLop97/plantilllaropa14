        ...
        >
          <div className="relative">
            ...
            <div className="relative aspect-square bg-gray-100 rounded-t-3xl overflow-hidden">
              {product.discount && (
                <div className="absolute top-4 left-4 bg-picton-blue-500 text-white text-xs font-semibold px-2 py-1 rounded-full z-10">
                  -{product.discount}%
                </div>
              )}
              <img
            ...
            <div className="p-6">
                ...
                {cartQty > 0 ? (
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl font-semibold transition-all duration-300 text-base
                      bg-gradient-to-r from-picton-blue-400 to-picton-blue-600 text-white hover:from-picton-blue-500 hover:to-picton-blue-700`}
                    style={{ minWidth: 0 }}
                  >
                    Añadir
                  </button>
              ...
              {cartQty > 0 && (
                <div className="text-xs text-gray-500 text-center">
                  Actualmente tienes <span className="font-bold text-picton-blue-600">{localQty}</span> en el carrito.
                </div>
              )}
            </div>
          </div>
