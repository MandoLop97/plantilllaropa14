...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-primary-50 to-primary-100 pt-12 pb-8 mt-16 border-t border-primary-50">
      <div className="max-w-3xl mx-auto px-4">
        <div className="text-center">
          ...
          <button 
            onClick={() => navigate('/')} 
            className="flex items-center justify-center gap-2 mb-4 group select-none focus:outline-none focus:ring-2 focus:ring-primary-400 rounded-lg p-2 mx-auto"
          >
          ...
          <div className="flex justify-center gap-5 mt-8 mb-2">
            <a
              ...
              aria-label="Facebook"
              className="rounded-full p-2 bg-white border border-primary-100 text-primary-500 hover:bg-primary-100 hover:text-primary-700 transition-colors shadow-sm"
            >
