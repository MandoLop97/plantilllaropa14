...
export const ProductFilters: React.FC<ProductFiltersProps> = ({
  ...
  // Diseño para escritorio optimizado
  return (
    <div className="bg-gradient-to-br from-white to-neutral-50 rounded-2xl shadow-lg border border-neutral-200 overflow-hidden">
      {/* Header fijo */}
      <div className="sticky top-0 z-10 bg-gradient-to-r from-white via-white to-neutral-50 p-6 border-b border-neutral-100">
        <div className="flex items-center justify-between">
          <h3 className="text-xl font-bold text-primary-800 tracking-tight">Filtros</h3>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={clearFilters}
            className="text-sm font-semibold text-primary-600 hover:text-primary-700 bg-gradient-to-r from-primary-100 to-primary-200 px-3 py-1.5 rounded-full transition-all shadow-sm hover:shadow-md"
          >
            Limpiar
          </motion.button>
        </div>
      ...
      <div className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl border-2 border-primary-200 focus:ring-2 focus:ring-primary-200 focus:border-primary-400 text-primary-800 bg-gradient-to-r from-primary-50 to-white placeholder:text-primary-400 transition-all shadow-sm"
            />
          </div>
        </div>

        {/* Categorías con grid optimizado */}
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <motion.button
              ...
              className={`flex flex-col items-center justify-center gap-2 p-3 rounded-xl border-2 transition-all shadow-sm hover:shadow-md
                ${!filters.category 
              ...
              `}
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-neutral-100 to-neutral-200 flex items-center justify-center overflow-hidden">
                <span className="text-xl">🛍️</span>
              </div>
              <span className="text-xs font-bold text-center">Todas</span>
            </motion.button>
            ...
            {categories.map((category) => {
              ...
              return (
                <motion.button
                  ...
                  `}
                >
                  <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-neutral-200 hover:ring-primary-300 transition-all">
                    <img 
                      src={categoryImage} 
                      alt={category.name} 
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder="Min"
              className="flex-1 px-3 py-2 rounded-lg border-2 border-primary-200 focus:ring-2 focus:ring-primary-200 focus:border-primary-400 text-primary-800 bg-gradient-to-r from-primary-50 to-white placeholder:text-primary-400 transition-all text-sm"
            />
            <div className="w-4 h-0.5 bg-gradient-to-r from-primary-400 to-primary-600 rounded-full"></div>
            <input
              type="number"
              value={filters.priceRange[1]}
              min={filters.priceRange[0]}
        ...
        <div className="space-y-3">
          ...
          <select
            value={filters.sortBy}
            onChange={(e) => onFilterChange({ sortBy: e.target.value as ProductFiltersType['sortBy'] })}
            className="w-full px-4 py-3 rounded-xl border-2 border-primary-200 focus:ring-2 focus:ring-primary-200 focus:border-primary-400 text-primary-800 bg-gradient-to-r from-primary-50 to-white transition-all shadow-sm"
          >
