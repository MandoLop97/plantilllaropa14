...
export const ProductSection: React.FC<ProductSectionProps> = ({
  ...
  const currentCategory = useMemo(() => categories.find(cat => cat.id === selectedCategory), [categories, selectedCategory]);
  ...
  return <section className="py-0">
      <div className="">
        ...
        <AnimatePresence mode="wait">
          ...
          // Products
          filteredProducts.map((product, index) => <motion.div key={product.id} {...animationVariants.scaleIn} transition={{
