...
export const EnhancedProductSection: React.FC = () => {
  ...
  const {
    ...
    error,
    refetch
  } = useEnhancedSupabaseProducts(selectedCategory);
  ...
  const currentCategory = useMemo(() => {
    // Simulamos las categorías por ahora - en el futuro se pueden obtener de Supabase
    const categories = [
      ...
      <section className="py-0">
        <div className={UI_CONFIG.CONTAINER_CLASSES}>
          <div className="text-center py-16">
            ...
            <button
              onClick={() => refetch()}
              className="bg-urban-500 text-white px-4 py-2 rounded-lg hover:bg-urban-600 transition-colors"
            >
              Reintentar
            </button>
          </div>
