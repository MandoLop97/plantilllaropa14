...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onClick, disableClick = false }) => {
  ...
  return (
    <motion.div 
      ...
      className={`group relative bg-white rounded-2xl shadow-lg hover:shadow-xl border border-neutral-200/50 hover:border-primary-300/60 transition-all duration-500 ${
        !disableClick && onClick ? 'cursor-pointer' : 'cursor-default'
      } overflow-hidden`}
