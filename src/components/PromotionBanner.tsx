  ...
  return (
    <section className="py-12 md:py-16" ref={bannerRef}>
      <div className="container mx-auto px-4">
        <motion.div 
          className="bg-gradient-to-r from-picton-blue-500 to-picton-blue-600 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden"
            ...
            >
              <div className="mb-6 md:mb-0 md:w-1/2 pr-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-white text-picton-blue-600 font-bold py-3 px-6 rounded-full shadow-md hover:shadow-lg transition-all"
                >
                  Comprar Ahora
                </motion.button>
              </div>
